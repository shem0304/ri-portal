...
"인천지역", "연계한", "구축을", "도입에", "부산지역", "부산의", "부산형", "울산의", "울산지역", "경북지역", "경북의", "경북형", "대전형"
]);
...
async function loadReports() {
  const apiUrl = (window.__TRENDS_BOOT__ && window.__TRENDS_BOOT__.api && window.__TRENDS_BOOT__.api.reports) || "./api/reports.php";
